...
## Testowanie rekomendera na różnych modelach i różnych kombinacji features
	   ...
	   ![alt text]([https://github.com/ArtsemHarachau/project1/master/project1/tuning_screens/combine_images_one-hot_min-max.png?raw=true](https://github.com/ArtsemHarachau/project1/blob/master/project1/tuning_screens/combine_images_one-hot_min-max.png))
